...
static bool fch_zen_get_smb_base(void);

static bool ich5_get_smb_base(void);
...
static bool find_smb_controller(uint16_t vid, uint16_t did) {
    ...
    switch(vid)
    {
      case VID_INTEL:
        switch(did)
        {
          case 0x2413: // 82801AA (ICH)
          case 0x2423: // 82801AB (ICH)
          case 0x2443: // 82801BA (ICH2)
          case 0x2483: // 82801CA (ICH3)
          case 0x24C3: // 82801DB (ICH4)
          case 0x24D3: // 82801E (ICH5)
          case 0x25A4: // 6300ESB
          case 0x266A: // 82801F (ICH6)
          case 0x269B: // 6310ESB/6320ESB
          case 0x27DA: // 82801G (ICH7)
          case 0x283E: // 82801H (ICH8)
          case 0x2930: // 82801I (ICH9)
          case 0x5032: // EP80579 (Tolapai)
          case 0x3A30: // ICH10
          case 0x3A60: // ICH10
          case 0x3B30: // 5/3400 Series (PCH)
          case 0x1C22: // 6 Series (PCH)
          case 0x1D22: // Patsburg (PCH)
          case 0x1D70: // Patsburg (PCH) IDF
          case 0x1D71: // Patsburg (PCH) IDF
          case 0x1D72: // Patsburg (PCH) IDF
          case 0x2330: // DH89xxCC (PCH)
          case 0x1E22: // Panther Point (PCH)
          case 0x8C22: // Lynx Point (PCH)
          case 0x9C22: // Lynx Point-LP (PCH)
          case 0x1F3C: // Avoton (SOC)
          case 0x8D22: // Wellsburg (PCH)
          case 0x8D7D: // Wellsburg (PCH) MS
          case 0x8D7E: // Wellsburg (PCH) MS
          case 0x8D7F: // Wellsburg (PCH) MS
          case 0x23B0: // Coleto Creek (PCH)
          case 0x8CA2: // Wildcat Point (PCH)
          case 0x9CA2: // Wildcat Point-LP (PCH)
          case 0x0F12: // BayTrail (SOC)
          case 0x2292: // Braswell (SOC)
          case 0xA123: // Sunrise Point-H (PCH)
          case 0x9D23: // Sunrise Point-LP (PCH)
          case 0x19DF: // Denverton  (SOC)
          case 0x1BC9: // Emmitsburg (PCH)
          case 0xA1A3: // Lewisburg (PCH)
          case 0xA223: // Lewisburg Super (PCH)
          case 0xA2A3: // Kaby Lake (PCH-H)
          case 0x31D4: // Gemini Lake (SOC)
          case 0xA323: // Cannon Lake-H (PCH)
          case 0x9DA3: // Cannon Lake-LP (PCH)
          case 0x18DF: // Cedar Fork (PCH)
          case 0x34A3: // Ice Lake-LP (PCH)
          case 0x38A3: // Ice Lake-N (PCH)
          case 0x02A3: // Comet Lake (PCH)
          case 0x06A3: // Comet Lake-H (PCH)
          case 0x4B23: // Elkhart Lake (PCH)
          case 0xA0A3: // Tiger Lake-LP (PCH)
          case 0x43A3: // Tiger Lake-H (PCH)
          case 0x4DA3: // Jasper Lake (SOC)
          case 0xA3A3: // Comet Lake-V (PCH)
          case 0x7AA3: // Alder Lake-S (PCH)
          case 0x51A3: // Alder Lake-P (PCH)
          case 0x54A3: // Alder Lake-M (PCH)
            return ich5_get_smb_base();
/*
          case 0x7113: // 82371AB/EB/MB PIIX4
          case 0x719B: // 82440/82443MX PMC
            return piix4_get_smb_base();
*/
...
/*
          ...
          case 0x746B: // AMD8111_SMBUS
            return amd756nforce_get_smb_base();
          case 0x746A: // AMD8111_SMBUS2
            return amd8111_get_smb_base();
          case 0x780B: // FCH SMBus Controller
            return piix4_get_smb_base();
*/
          case 0x790B: // AMD FCH (Zen 2/3)
            return fch_zen_get_smb_base();
          default:
            return false;
        }
        break;
